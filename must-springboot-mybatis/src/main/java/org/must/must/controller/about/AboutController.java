 ...
 * <P>TODO</P>
 * @version $Id$
 * @user xxx  2021年2月2日 下午2:37:49
 */

@Controller
@Slf4j
@RequestMapping(value = "must")
public class AboutController extends DefaultController{
	
	@GetMapping("about_index")
	public String index(HttpServletRequest request) {
		log.info("進入AboutController");
		return "mustEn/about_index";
	}	
}
